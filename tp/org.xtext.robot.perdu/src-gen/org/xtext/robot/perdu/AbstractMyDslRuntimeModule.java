...
import org.xtext.robot.perdu.formatting2.MyDslFormatter;
import org.xtext.robot.perdu.generator.MyDslGenerator;
import org.xtext.robot.perdu.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.robot.perdu.parser.antlr.MyDslParser;
import org.xtext.robot.perdu.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.robot.perdu.scoping.MyDslScopeProvider;
import org.xtext.robot.perdu.serializer.MyDslSemanticSequencer;
import org.xtext.robot.perdu.serializer.MyDslSyntacticSequencer;
import org.xtext.robot.perdu.services.MyDslGrammarAccess;
import org.xtext.robot.perdu.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/robot/perdu/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.robot.perdu.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("perdu");
	}
