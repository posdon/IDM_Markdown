...
public class ProgramUnitItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RobotPackage.Literals.PROGRAM_UNIT__BLOCK,
				 robot.flotCtrl.FlotCtrlFactory.eINSTANCE.createWhileLoop()));

		newChildDescriptors.add
			(createChildParameter
				(RobotPackage.Literals.PROGRAM_UNIT__BLOCK,
				 robot.flotCtrl.FlotCtrlFactory.eINSTANCE.createNegExp()));

		newChildDescriptors.add
			(createChildParameter
				(RobotPackage.Literals.PROGRAM_UNIT__BLOCK,
				 robot.flotCtrl.FlotCtrlFactory.eINSTANCE.createAndExp()));

		newChildDescriptors.add
			(createChildParameter
				(RobotPackage.Literals.PROGRAM_UNIT__BLOCK,
				 robot.flotCtrl.FlotCtrlFactory.eINSTANCE.createIfBlock()));
	}
