 ...
 *   <li>{@link markdown.impl.ImageExpressionImpl#getTextBloc <em>Text Bloc</em>}</li>
 *   <li>{@link markdown.impl.ImageExpressionImpl#getIsReferenced <em>Is Referenced</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageExpressionImpl extends ExpressionImpl implements ImageExpression {
			...
			if (textBloc != oldTextBloc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MarkdownPackage.IMAGE_EXPRESSION__TEXT_BLOC, oldTextBloc, textBloc));
			}
		}
		return textBloc;
	}
	...
	public void setTextBloc(EmphasisExpression newTextBloc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MarkdownPackage.IMAGE_EXPRESSION__TEXT_BLOC,
	...
	public void setIsReferenced(Boolean newIsReferenced) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MarkdownPackage.IMAGE_EXPRESSION__IS_REFERENCED,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MarkdownPackage.IMAGE_EXPRESSION__TEXT_URL:
			return getTextURL();
		case MarkdownPackage.IMAGE_EXPRESSION__TEXT_BLOC:
			if (resolve)
				return getTextBloc();
