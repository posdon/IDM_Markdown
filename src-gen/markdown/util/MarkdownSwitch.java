...
public class MarkdownSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MarkdownPackage.TEXT_BLOC: {
			TextBloc textBloc = (TextBloc) theEObject;
			T result = caseTextBloc(textBloc);
			if (result == null)
				result = caseEmphasisExpression(textBloc);
			if (result == null)
				result = caseTextExpression(textBloc);
			if (result == null)
				result = caseExpression(textBloc);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Text Bloc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Text Bloc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTextBloc(TextBloc object) {
		return null;
	}
