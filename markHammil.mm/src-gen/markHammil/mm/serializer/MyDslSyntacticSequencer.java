...
public class MyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Expression_BLTerminalRuleCall_0_2_1_q;
	...
	protected AbstractElementAlias match_ListExpression_WSTerminalRuleCall_0_1_1_a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Expression_BLTerminalRuleCall_0_2_1_q = new TokenAlias(false, true, grammarAccess.getExpressionAccess().getBLTerminalRuleCall_0_2_1());
		...
		match_ListExpression_WSTerminalRuleCall_0_1_1_a = new TokenAlias(true, true, grammarAccess.getListExpressionAccess().getWSTerminalRuleCall_0_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Expression_BLTerminalRuleCall_0_2_1_q.equals(syntax))
				emit_Expression_BLTerminalRuleCall_0_2_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_ListExpression_WSTerminalRuleCall_0_1_1_a.equals(syntax))
				emit_ListExpression_WSTerminalRuleCall_0_1_1_a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     contentOrdered+=TextExpression BL? (ambiguity) (rule end)
	 *     contentUnordered+=TextExpression BL? (ambiguity) (rule end)
	 */
	protected void emit_Expression_BLTerminalRuleCall_0_2_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     c=ImageExpression (ambiguity) (rule end)
	 *     c=LinkExpression (ambiguity) (rule end)
	 *     c=QuoteExpression (ambiguity) (rule end)
	 *     c=TabExpression (ambiguity) (rule end)
	 *     c=VideoExpression (ambiguity) (rule end)
	 */
	 ...
	 *     contentUnordered+=TextExpression (ambiguity) BL? (rule end)
	 */
	 ...
	 *     contentOrdered+=TextExpression (ambiguity) BL? (rule end)
	 ...
	 */
	protected void emit_ListExpression_WSTerminalRuleCall_0_1_1_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
