...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  private EClass urLedExpressionEClass = null;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EClass getURLedExpression()
  {
		return urLedExpressionEClass;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EReference getURLedExpression_C()
  {
		return (EReference)urLedExpressionEClass.getEStructuralFeatures().get(0);
	}
  ...
  public void createPackageContents()
  {
		...
		urLedExpressionEClass = createEClass(UR_LED_EXPRESSION);
		createEReference(urLedExpressionEClass, UR_LED_EXPRESSION__C);
  ...
  public void initializePackageContents()
  {
		...
		urLedExpressionEClass.getESuperTypes().add(this.getTextExpression());
		...
		initEClass(horizontalExpressionEClass, HorizontalExpression.class, "HorizontalExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(urLedExpressionEClass, URLedExpression.class, "URLedExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getURLedExpression_C(), ecorePackage.getEObject(), null, "c", null, 0, 1, URLedExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
